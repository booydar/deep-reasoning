...
for N in 1; do
    ...
    for LR in 1e-03; do
        ...
        --output_dir ${RUNS_DIR}/${TASK_NAME}/${MODEL_NAME}/${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_${INPUT_SEQ_LEN}_LR${LR}-from_scratch-cot-v2/run${N} \
        ...
        --learning_rate ${LR} --lr_scheduler_type $SCHEDULER --warmup_steps 20000 \
        --min_lr 5e-05 \
        --data_n_workers 2 \
