...
accelerate launch --num_processes $NP --config_file $ACCEL_CONFIG --main_process_port 29002 $MAIN_SCRIPT \
        ...
        --output_dir ${RUNS_DIR}/${DATASET_NAME}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_nfs_curr/run_$N \
        --model_cpt /home/jovyan/bulatov/rmt/runs/wikitext/gpt2/linear_adamw_wd1e-03_2x512_mem16_bs256_bptt--1_nfs/run_1/checkpoint-24500/pytorch_model.bin \
