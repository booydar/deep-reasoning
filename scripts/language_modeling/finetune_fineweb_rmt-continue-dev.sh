...
accelerate launch --num_processes $NP --config_file $ACCEL_CONFIG --main_process_port 29002 $MAIN_SCRIPT \
        ...
        --checkpoint /home/jovyan/bulatov/rmt/runs/fineweb-edu/SmolLM2-135M/LR3e-04_constant_adamw_wd1e-03_2x512_mem32_bs1024_bptt--1-bs1024-nfs/run_1/checkpoint-22500 \
