...
accelerate launch --num_processes $NP --config_file $ACCEL_CONFIG --main_process_port 29033 $MAIN_SCRIPT \
        ...
        --checkpoint /home/jovyan/bulatov/rmt/runs/fineweb-edu/SmolLM2-135M/LR1e-04_constant_adamw_wd1e-03_8x64_mem32_bs1024_bptt--1-bs1024-nfs/run_1/checkpoint-13000 \
