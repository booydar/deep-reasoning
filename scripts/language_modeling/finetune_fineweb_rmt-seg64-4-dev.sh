...
accelerate launch --num_processes $NP --config_file $ACCEL_CONFIG --main_process_port 29033 $MAIN_SCRIPT \
        ...
        --model_cpt /home/jovyan/bulatov/rmt/runs/fineweb-edu/SmolLM2-135M/LR1e-04_constant_adamw_wd1e-03_8x64_mem32_bs1024_bptt--1-bs1024-nfs/run_1/checkpoint-15000/pytorch_model.bin \
