...
RECURRENT_WRAPPER=modeling_rmt.experimental:RecurrentWrapperNoSegmentationWeighLoss
...
for N in 1; do
    ...
    for LR in 1e-03; do
        ...
        --output_dir ${RUNS_DIR}/${TASK_NAME}/${MODEL_NAME}/${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_${INPUT_SEQ_LEN}_LR${LR}_AW${AW}-cot-v2 \
