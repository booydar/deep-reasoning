...
for N in 1; do
    ...
    for LR in 5e-04; do
        ...
        --output_dir ${RUNS_DIR}/${TASK_NAME}/${MODEL_NAME}/${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_${INPUT_SEQ_LEN}_LR${LR}-cot-v2-continue \
        --checkpoint /workspace-SR006.nfs2/bulatov/rmt/runs/multiplication_4x4/gpt2/1x1024_mem16_1024_LR1e-04-cot-v2-continue/checkpoint-200000 \
        ...
        --min_lr 5e-05 \
        --data_n_workers 2 \
        --logging_steps 200 --eval_steps 1000 --save_steps 2000 \
